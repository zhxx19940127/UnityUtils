...
namespace LitJson
{
    ...
    internal struct ObjectMetadata
    {
        ...
        public IDictionary<object, PropertyMetadata> Properties { get; set; }
    }
            ...
            foreach (var p_info in type.GetProperties())
            {
                if (p_info.Name == "Item")
                {
                    ...
                    if (parameters[0].ParameterType == typeof(string))
                    {
                        ...
                        {
                            data.ElementType =
 ((ILRuntime.Reflection.ILRuntimeWrapperType)type).CLRType.GenericArguments[1].Value.ReflectionType;
                        }
                        else
#endif
                        data.ElementType = p_info.PropertyType;
        ...
        private static void AddTypeProperties(Type type)
        {
            ...
            foreach (var p_info in type.GetProperties(BindingFlags.Instance | BindingFlags.Public))
            {
                if (p_info.Name == "Item")
                    continue;
            ...
            foreach (var f_info in type.GetFields(BindingFlags.Instance | BindingFlags.Public))
            {
                var p_data = new PropertyMetadata();
                p_data.Info = f_info;
                p_data.IsField = true;
        ...
        private static object ReadValue(Type inst_type, JsonReader reader)
        {
            ...
            var underlying_type = inst_type; //Nullable.GetUnderlyingType(inst_type);
            var value_type = inst_type;
                ...
                reader.Token == JsonToken.Boolean)
            {
                ...
                var conv_op = GetConvOp(vt, json_type);
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                if (typeof(IList).IsAssignableFrom(prop_data.Type))
                                {
                                    ...
                                    foreach (var o in (IList)ReadValue(prop_data.Type, reader)) sourceList.Add(o);
                                }
                            }
                        }
                    }
        ...
        public static object ToObject(JsonReader reader, Type type)
        {
        ...
        private static unsafe StackObject* JsonToObject(ILIntepreter intp, StackObject* esp, IList<object> mStack, CLRMethod method, bool isNewObj)
        {
            ...
            System.String json =
 (System.String)typeof(System.String).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, mStack));
        ...
        private unsafe static StackObject* JsonToObject2(ILIntepreter intp, StackObject* esp, IList<object> mStack, CLRMethod method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(esp, 1);
            ptr_of_this_method = ILIntepreter.Minus(esp, 1);
            JsonReader json =
 (JsonReader)typeof(JsonReader).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, mStack));
            intp.Free(ptr_of_this_method);
            var type = method.GenericArguments[0].ReflectionType;
        ...
        private unsafe static StackObject* JsonToObject3(ILIntepreter intp, StackObject* esp, IList<object> mStack, CLRMethod method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(esp, 1);
            ptr_of_this_method = ILIntepreter.Minus(esp, 1);
            TextReader json =
 (TextReader)typeof(TextReader).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, mStack));
            intp.Free(ptr_of_this_method);
            var type = method.GenericArguments[0].ReflectionType;
            var result_of_this_method = ReadValue(type, new JsonReader(json));
